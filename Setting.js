...
global.owner = process.env.OWNER_NUMBER  || '21288813246' ;  // ADD YOUR NUMBER WITHOUT +
...
global.mztit = process.env.MZTIT ||"Mo3giza/𝑲𝑹𝒐𝒛 𒉭",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '05_05_2024_SIGMA_MD_ET94ScR3_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'Mo3giza/𝑲𝑹𝒐𝒛 𒉭',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Mo3giza/𝑲𝑹𝒐𝒛 𒉭`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Mo3giza/𝑲𝑹𝒐𝒛 𒉭',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "Mo3giza/𝑲𝑹𝒐𝒛 𒉭" ,          // ADD YOUR STICKER PACKNAME
  ...
  LANG: process.env.THEME || "Mo3giza/𝑲𝑹𝒐𝒛 𒉭",
